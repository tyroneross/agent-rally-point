---
name: feedback
description: Report a bug or send feedback about the agent-rally-point plugin
---

# Report agent-rally-point feedback

File the user's report as a GitHub issue on `tyroneross/agent-rally-point`. GitHub issues are this
plugin's support channel.
...
```bash
gh issue create --repo tyroneross/agent-rally-point \
...
5. If `gh` is missing or unauthenticated, do not fail — print the URL so the user
   can open it in a browser: https://github.com/tyroneross/agent-rally-point/issues/new
